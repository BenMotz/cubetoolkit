...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EventTag', fields ['slug']
        db.create_unique('EventTags', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventTag', fields ['slug']
        db.delete_unique('EventTags', ['slug'])
