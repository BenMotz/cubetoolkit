...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Showing', fields ['start']
        db.create_index('Showings', ['start'])


    def backwards(self, orm):
        # Removing index on 'Showing', fields ['start']
        db.delete_index('Showings', ['start'])
    ...
    models = {
        ...
        u'diary.event': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'db_index': 'True', 'to': u"orm['diary.EventTag']", 'symmetrical': 'False', 'db_table': "'Event_Tags'", 'blank': 'True'}),
