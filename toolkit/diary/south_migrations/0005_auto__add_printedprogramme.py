...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrintedProgramme'
        db.create_table('PrintedProgrammes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('month', self.gf('django.db.models.fields.DateField')(unique=True)),
            ('programme', self.gf('django.db.models.fields.files.FileField')(max_length=256)),
            ('designer', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(max_length=8192, null=True, blank=True)),
        ))
        db.send_create_signal(u'diary', ['PrintedProgramme'])


    def backwards(self, orm):
        # Deleting model 'PrintedProgramme'
        db.delete_table('PrintedProgrammes')
