    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('film_information', models.CharField(max_length=256, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('media_file', models.ImageField(max_length=256, upload_to=b'diary', null=True, verbose_name=b'Image file', blank=True)),
                ('mimetype', models.CharField(max_length=64, editable=False)),
                ('credit', models.CharField(default=b'Internet scavenged', max_length=256, null=True, verbose_name=b'Image credit', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programme', models.FileField(upload_to=b'printedprogramme', max_length=256, verbose_name=b'Programme PDF')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard', models.BooleanField(default=False, help_text=b'Should this role be presented in the main list of roles for events')),
