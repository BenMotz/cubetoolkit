...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaItem.media_file'
        # db.alter_column('MediaItems', 'media_file', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))
        # This is a no-op (whatever happens, it's still storing a file path,
        # not an actual image)
        pass
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MediaItem.media_file'
        # db.alter_column('MediaItems', 'media_file', self.gf('django.db.models.fields.files.FileField')(max_length=256, null=True))
        # no-op, as above
        pass
    ...
    models = {
        ...
        u'diary.mediaitem': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_file': ('django.db.models.fields.files.ImageField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
        ...
        u'diary.showing': {
            ...
            'rota_notes': ('django.db.models.fields.TextField', [], {'max_length': '1024', 'blank': 'True'}),
