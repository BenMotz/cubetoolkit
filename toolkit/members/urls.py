...
from toolkit.members.volunteer_views import (view_volunteer_list,
        view_volunteer_role_report, edit_volunteer, select_volunteer,
        activate_volunteer)

from toolkit.members.member_views import (add_member, search, view,
...
volunteer_urls = [
    ...
    url(r'^unretire/select$', select_volunteer,
        name='unretire-select-volunteer', kwargs={'action': 'unretire', 'active': False}),
    ...
    url(r'^retire$', activate_volunteer,
        name='inactivate-volunteer', kwargs={'set_active': False}),
]
