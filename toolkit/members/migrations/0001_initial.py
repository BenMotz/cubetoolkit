    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posttown', models.CharField(max_length=64, null=True, blank=True)),
                ('postcode', models.CharField(max_length=16, null=True, blank=True)),
                ('country', models.CharField(max_length=32, null=True, blank=True)),
                ('website', models.CharField(max_length=128, null=True, blank=True)),
                ('phone', models.CharField(max_length=64, null=True, blank=True)),
                ('altphone', models.CharField(max_length=64, null=True, blank=True)),
                ('notes', models.TextField(null=True, blank=True)),
                ('is_member', models.BooleanField(default=True)),
                ('mailout', models.BooleanField(default=True)),
                ('mailout_failed', models.BooleanField(default=False)),
                ('mailout_key', models.CharField(default=toolkit.util.generate_random_string, max_length=32, editable=False)),
