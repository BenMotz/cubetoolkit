...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.is_member'
        db.add_column('Members', 'is_member',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.is_member'
        db.delete_column('Members', 'is_member')
    ...
    models = {
        ...
        u'members.member': {
            ...
            'mailout_key': ('django.db.models.fields.CharField', [], {'default': "'PCRd1N6yMvNJuf4Lw9ryvKs1yQt3XF2D'", 'max_length': '32'}),
