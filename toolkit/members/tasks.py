...
def _get_text_preamble_signature(recipient):
    ...
    if False:  # not(recipient.gdpr_opt_in):
        gdpr_opt_in_template = (
            "If you'd like to continue to receive emails about events and fundraising for the Cube, "
            "you'll need to make sure you opt-in before 25 May 2018.\n\n"
            "Please choose to opt-in so you won't miss out on what's happening at your favourite Microplex.\n\n"
